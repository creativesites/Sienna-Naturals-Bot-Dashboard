// components/child/HairConcersOverviewChart.js
"use client";
...
const HairConcersOverviewChart = () => {
       ...
       <div className="myavana-container">
          ...
          <div className="myavana-content">
            <div>
              ...
              <div className="myavana-timestamp">Hair Concerns</div>
            </div>
...
export default HairConcersOverviewChart;